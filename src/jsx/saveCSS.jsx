function saveCss () {
	...
	*/
	...
	cssToClip.copyCSSToClipboard = function()
	{
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////////////
						//THIS IS WHERE WE INJECTED OUR CODE TO EXPORT THE CSS
		////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		try {
		...
		if (xLib) {
		    ...
		    eventObj.type = "outputLayerCSS";
		    eventObj.data = this.cssText;
		    eventObj.dispatch();
		};
	...
	cssToClip.countGroupLayers = function( layerGroup )
	{
	    ...
	    var groupLayers = this.getGroupLayers( currentLayer, cssToClip.isCSSLayerKind );
	    var i, visLayers = 0;
